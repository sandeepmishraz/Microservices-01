...
@Tag(
        ...
        description = "CRUD REST APIs for Accounts in EazyBank to CREATE,UPDATE,FETCH AND DELETE"
)
@RestController
...
//    } Not required if you ahve autowired
    ...
    public ResponseEntity<String> getBuildId()
    {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(buildValue);
    ...
    public ResponseEntity<String> getJavaVersion()
    {
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(environment.getProperty("MAVEN_HOME")+" "+environment.getProperty("JAVA_HOME"));
    }
